  ...
  return (
    ...
    >
      <div className="w-full py-6 flex items-center justify-between border-b border-primary-500 lg:border-none">
        ...
        <div className="flex w-full ml-16 space-x-8 lg:block">
          <div className="text-base font-medium text-white hover:text-primary-50">
            <ConnectWallet />
          </div>

        </div>
          <Link href={"/MyVideo"} className="text-base font-medium text-black w-36 py-2 hover:text-primary-50 bg-white">
              My Videos
          </Link>
      </div>
